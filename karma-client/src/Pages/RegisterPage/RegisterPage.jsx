                ...
                <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
                    ...
                    >
                        <div className="max-w-xl lg:max-w-3xl">
                            <div className="relative -mt-1 py-26 block lg:hidden">
                                <a
                                    className="inline-flex h-16 w-16 items-center justify-center rounded-full bg-gray-300 text-blue-600 dark:bg-gray-900 sm:h-20 sm:w-20"
                                    href="/"
                                >
                                    <span className="sr-only">Home</span>
                                    <svg
                            ...
                            <form action="#" onSubmit={handleSubmit} className="mt-8 grid grid-cols-6 gap-6" >
                                ...
                                <div className="col-span-6 sm:col-span-3">
                                    ...
                                    <input
                                        ...
                                        id="profession"
                                        name="profession"
                                        placeholder="e.g- Web developer,Digital Market"
                                        className="mt-1 py-2 pl-4  w-full rounded-md border-gray-200 bg-gray-300 text-sm  shadow-sm"
                                    />
                                </div>
                                ...
                                <div className="col-span-6">
                                    <label htmlFor="MarketingAccept" className="flex gap-4">
                                        <input
                                            ...
                                            className="h-5 px-2 w-5 rounded-md border-gray-200 bg-gray-300 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:focus:ring-offset-gray-900"
                                        />
                                ...
                                <div className="col-span-6">
                                    <p className="text-sm text-gray-500 dark:text-gray-400">
                                        ...
                                        <a href="#" className="text-gray-500 underline dark:text-gray-200">
